...
i = 1 
repeat{
  source("SVM_Random.R") ##Source the script for the scenario you would like to run##
  ...
  ##write files
  write.csv(allResults, "SVM_random_Allgvs_SRN_Yield.csv")
  write.csv(corResults, "SVM_random_Correlation_SRN_Yield.csv")
