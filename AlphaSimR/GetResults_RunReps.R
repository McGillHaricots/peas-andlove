### This script will run a given simulation for a specified number of reps
### The genetic values from each generation and each rep will be written into a data frame called allResults
### Model performance (Pearson correlaton) will be written into a data frame called corResults
...
i = 1 
repeat{
  source("rrBLUP_stratClusters_SRNM_Flowering.R") ##Source the script for the scenario you would like to run##
  ...
  ##write files
  write.csv(allResults, "BLUP_stratClusters_Allgvs_SRNM_Flowering.csv")
  write.csv(corResults, "BLUP_stratClusters_Correlation_SRNM_Flowering.csv")
