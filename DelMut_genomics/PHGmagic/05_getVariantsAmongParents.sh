...
apptainer exec --no-home --bind /home/henry96/projects/def-haricots/cbsublfs1_Cornell/run_phg/phg:/mnt/phg,/scratch/henry96/MAGIC_Rils_BAM:/mnt/MAGIC_Rils_BAM phg_1.4.sif \
    ./tassel-5-standalone/run_pipeline.pl -Xmx500G -debug -configParameters /mnt/phg/config.txt -HaplotypeGraphBuilderPlugin -configFile /mnt/phg/config.txt -methods reads_aligned \
	-includeVariantContexts true -includeSequences false -endPlugin \
	-PathsToVCFPlugin -outputFile /mnt/phg/imputedVCF/MAGIC_Parents.vcf -referenceFasta /mnt/phg/inputDir/reference/PvulgarisUI111_534_v1.0.fa -endPlugin
