...
#Figure4a - No Treatment - Sensor pH
...
Fig4 <- annotate_figure(Fig4, top = text_grob("No Treatment", color = "black", face = "bold", size = 12)) #Adding a main title above the panels
Fig4
```
...
ggsave(plot=Fig4, file="Fig4-NoTreatment-pH.tiff", units="cm", width=18, height=12, dpi=600, compression='lzw')
ggsave(plot=Fig4, file="Fig4-NoTreatment-pH.pdf", units="cm", width=18, height=12, dpi=600)
```
